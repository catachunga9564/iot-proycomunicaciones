...
String uid;
String databasePath, tempPath, qualPath, humPath, presPath, ledPath,altPath,reportPath,ultimoReportePath,voltajeBatPath;
...
const unsigned long intervalo2 = 5 * 1000000;       //*************************** TIEMPO PARA ENVÍO DE DATOS**************************//
...
void loop(){
  ...
  quality = MQGetGasPercentage(MQRead(MQ_PIN)/Ro,GAS_CO2) + 410;
  ...
  if (has_expired2 && Firebase.ready()){
